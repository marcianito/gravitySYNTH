#' @title Compare differences of nightly averages to daily diferences from actual time series 
#'
...
difs_nightlyAvg = function(
    ...
    # avg_start = hour_start
    # avg_end = hour_end
    #
    ## create daily data, averaged in desired time period
    data_nightlyAvg = data_observed %>%
    ...
    # at a daily basis
    observed_difsDaily = data_nightlyAvg
